...
#include <Wire.h> // Comunicació I2C (és inclòs per Adafruit_BMP280)
#include <Adafruit_BMP280.h> // Per a facilitar l'ús del BMP280


// Defineixo els pins que utilitzaré en la comunicació I2C
#define SCL 3 // Aquí és on vaig tenir un error, hauria d'haver-lo connectat a l'A5
#define SDA 4
