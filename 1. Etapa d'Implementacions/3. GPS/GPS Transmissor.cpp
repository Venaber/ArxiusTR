...
/****  BMP280 + GPS  ****/
float ack[3]; // Variable per emmagatzemar les dades enviades pel dron, és important que sigui float
...
void pantalla() {
  ...
  if(tempsPantalla - counterPantalla >= intervalPantalla && pantallaTouch.getPoint().z > 100) {
    ...
    pantallaGraphics.setCursor(100, 40);
    pantallaGraphics.print("A:");
    pantallaGraphics.setCursor(120, 40);
    pantallaGraphics.print(ack[0]);
    pantallaGraphics.setCursor(150, 40);
    pantallaGraphics.print(" m");

    pantallaGraphics.setCursor(100, 50);
    pantallaGraphics.print("La:");
    pantallaGraphics.setCursor(120, 50);
	  pantallaGraphics.print(ack[1], 6);
    pantallaGraphics.setCursor(170, 50);
    
    pantallaGraphics.setCursor(100, 60);
    pantallaGraphics.print("Lo:");
    pantallaGraphics.setCursor(120, 60);
	  pantallaGraphics.print(ack[2], 6);
    pantallaGraphics.setCursor(146, 60);
...
void setup() {
  ...
  pantallaGraphics.setTextSize(1);
